export const callOfTheSiren = {
  frag: `//Parts of this shader code are based on the work of Blackle Mori / https://www.shadertoy.com/view/wtVyWK
    ...
    void mainImage( out vec4 fragColor, in vec2 fragCoord )
    {
        vec2 uv = fragCoord/uResolution.xy;
         ...
         vec2 pn = (uPosition.xy/uResolution.xy)*vec2(2.0,-2.0)+vec2(-1.,1.0)+vec2(cos(uTime),sin(uTime))*0.2;
         pn.y -= 0.2;
         fragColor = r(( (uv)*vec2(2.0,-2.0)+vec2(-1.,1.0))*vec2(uResolution.x/uResolution.y,1.0),uTime,pn); 
