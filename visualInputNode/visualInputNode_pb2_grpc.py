...
import visualInputNode_pb2 as visualInputNode__pb2
...
class VisualInputNodeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.InitializeVisualInputNode = channel.unary_unary(
                ...
                request_serializer=visualInputNode__pb2.InitializeVisualInputNodeRequest.SerializeToString,
                response_deserializer=visualInputNode__pb2.InitializeVisualInputNodeResponse.FromString,
                )
...
def add_VisualInputNodeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'InitializeVisualInputNode': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=visualInputNode__pb2.InitializeVisualInputNodeRequest.FromString,
                    response_serializer=visualInputNode__pb2.InitializeVisualInputNodeResponse.SerializeToString,
            ),
    }
...
class VisualInputNodeService(object):
    ...
    def InitializeVisualInputNode(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/visualInputNode.VisualInputNodeService/InitializeVisualInputNode',
            visualInputNode__pb2.InitializeVisualInputNodeRequest.SerializeToString,
            visualInputNode__pb2.InitializeVisualInputNodeResponse.FromString,
